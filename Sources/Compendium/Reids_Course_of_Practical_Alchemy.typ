...
== John Reid's Course of Practical Alchemy
_by John Reid III, Second Edition (1993). Magnum Opus, Inc._

#hm-note[
  John Reid III is a self-taught practitioner who, working largely through divine revelation and persistent laboratory experience, produced the clearest English-language account of the transition from spagyric to alchemical plant work available in the modern era.\
  
  His unique contribution is the complete Minor Opus (Plant Stone) protocol taken through all colour stages with photographic documentation, and his distinction between "spagyric" and "alchemical" products — the former separating what nature has already manifested, the latter generating the spark of life itself by art.\

  Reid's Three Essentials doctrine diverges significantly from Albertus and Junius: ethyl alcohol, volatile oil, and mineral salts are *vehicles* of the essentials, not the essentials themselves.\
  
  The essentials proper are the two celestial waters — the condensed starlight (Sulfur/male) and the collected precipitation (Salt/female) — whose preparation is the subject of Chapter 8.\
  
  In the TTAO curriculum, Reid is the primary authority for the Water Work and sealed-vessel fermentation (Year 2), and the Minor Opus photographic sequence (Chapters 9 and Conclusion) is the definitive visual reference for the colour progression of the Plant Stone.
]
#pagebreak()
#set align(center)
...
This book is dedicated to the one true love of my life, my darling Nicholeine. Her love and support have buoyed me through the darkest times of self-doubt and fear.\ 
#set align(left)
...
Finally, thanks must be given to Frater Albertus and Manfred M. Junius for their books, As well as to A. Cockren, Basil Valentine, Eirenaeus Philalethes, Paracelsus, and all the other philosophers who have left to us the gifts of their works to study and learn from.
...
#set align(center)
== Forward to the Second Edition\ Gentle reader,
...
#set align(center)
== Chapter 3\ The Four Alchemical Elements

".... so also this One Thing is an indestructible essence..."\ 
#set align(left)

#quote(".... It is neither hot and dry like fire, nor cold and moist like water, nor warm and moist like air, nor dry and cold like earth. But it is a skillful perfect equation of all the elements.")\
From the book of "_The Revelation of Hermes_" Interpreted by Paracelsus.\ 
...
"And God said, let there be lights in the firmament of the heaven to divide the day from the night: and let them be for signs, and for seasons, and for days, and years." Genesis 1:14 I am not going to try to teach astro-cyclic pulsations here (a.k.a. astrology). What will be attempted in as short a form as possible is to give the salient points about this subject, so that one can use the information in the production of alchemical products. Anyone not familiar with the production of a horoscope will have to teach themselves this subject. There are many fine books out from which to learn. Astro-cyclic pulsations is a term coined by the late Frater Albertus. He contended that the universe and all things within it moved, grew, and evolved in a cyclic fashion. The energies that helped to shape human history--be they material, immaterial, or a combination of the two--repeat or manifest themselves in regular cyclic fashion. I am not saying, nor do I think Albertus meant, that you can tell a person's exact future. There are too many variables that come into play for this to be done, the greatest of which is the free will of the individual(s) in question. What can be done, though, is a correlation of past events to the energies emitted by the star groups and planets at the time, while considering their positions and angles to one another. By comparing the energy patterns and events of the past to the energy patterns of present and future times, one can extrapolate that similar events in human history will manifest themselves. It is strongly suggested to the reader unfamiliar with Albertus's work to read the titles listed in the suggested readings section. Albertus used cyclic charts to show the energy patterns that ranged over thousands of years down to days, hours, and minutes. For our purposes, we will look at daily and hourly cycles. All astro-cyclic pulsation charts can be expressed in two manners. The seven or twelve phase cycles. The seven phase cycle deals with the spiritual/mental influences upon terrestrial organisms as revealed by the seven planetary intelligence's of the ancients. It of course is a well-known fact there are more than just seven planets in our solar system.Astronomers say there are nine of them, while Albertus claims there are three more planets yet to be discovered. For the sake of simplicity, we will confine our presentation to the seven planets of the ancients. It takes very little math to establish which planetary intelligence(s) is operative in any given hour of any day of the week. This is because each day of our week is ruled by one of the seven planets of the ancients. Moreover, each day can be subdivided into seven separate periods. So that each period of the day is ruled by the planet ruling that day with a little tingeing influence placed upon it by its co-ruler for that period. The following sequence of planets, days and numbers is the one agreed upon and used by most of the alchemists that I know. Table1 shows the planet, weekday, and quabbalistic number. Table 2 shows the seven time intervals, the seven period letters, and quabbalistic number. Table 3 shows the primary relationships of the planets.\ 
#set align(left)

#figure(
  ttao-table(
    columns: (auto, auto, auto),
    table.header[*Planet*][*Weekday*][*Q.B.L. No.*],
    [Sun], [Sunday], [6],
    [Moon], [Monday], [9],
    [Mars], [Tuesday], [5],
    [Mercury], [Wednesday], [8],
  ...
  caption: [Table 1 — Planets, Weekdays, and Qabbalistic Numbers],
)
#v(3em)
#line(length: 100%)
#v(3em)
#figure(
  ttao-table(
    columns: (auto, auto, auto),
    table.header[*Time Interval*][*Period*][*Q.B.L. No.*],
  ...
  caption: [Table 2 — Time Intervals, Period Letters, and Qabbalistic Numbers],
)
#v(3em)
#line(length: 100%)
#v(3em)
#figure(
  ttao-table(
    ...
    table.header[*Planet*][*Metal*][*Cardinal Sin*][*Cardinal Virtue*][*Part of Body*],
...
The first decan of a sign always begins with the sign itself; subsequent decans follow the same elemental triplicity. Dwadashamsas subdivide each decan into four 2.5° segments following the natural progression of the zodiac from that decan's ruling sign.

#v(2em)

#figure(
  caption: [*Table 5 — Decans and Dwadashamsas of the Zodiac*],
  ttao-table(
    columns: (auto, auto, auto, auto),
    [*Aries Decan*], [*Degrees*], [*Ruling Sign*], [*Dwadashamsas (2.5° each)*],
    [1st Decan], [0° – 10°], [Aries], [Aries 0.0–2.5° / Taurus 2.6–5.0° / Gemini 5.1–7.5° / Cancer 7.6–10.0°],
    [2nd Decan], [10° – 20°], [Leo], [Leo 10.1–12.5° / Virgo 12.6–15.0° / Libra 15.1–17.5° / Scorpio 17.6–20.0°],
    [3rd Decan], [20° – 30°], [Sagittarius], [Sagittarius 20.1–22.5° / Capricorn 22.6–25.0° / Aquarius 25.1–27.5° / Pisces 27.6–30.0°],
  )
)
...
When using these tables one need not necessarily correlate their actions with that of a traditional horoscope. For our purposes here we are concerned more with the seven-phase cycle as it applies to the day and hours and the twelve-phase cycle as it applies to the moon. The basic guidelines I use for these tables are as follows.\ 
...
#set align(center)
== Chapter 1\ Lab Equipment Needed
#set align(left)
...
#figure(
  ttao-table(
    columns:(auto, auto, auto),
    table.header[*Supplies*][*Quantity*][*Approximate Price*],
...
#figure(
  ttao-table(
    columns:(auto, auto, auto),
    table.header[*Materials*][*Quantity*][*Approximate Price*],
    ...
    [Sand],[],[Free],
    [Stainless Steel Screwdriver],[1],"$7.00",
    [Thermometer Distilling $150degree C$],[2],"$30.00",
...
#figure(
  ttao-table(
    columns:(auto, auto, auto),
    table.header[*Equipment*][*Quantity*][*Approximate Price*],
    ...
    [Double Joint Expansion Bulb, 24/40 Bottom, 75/50 top],[2],"$200.00",
...
1) Distill slowly and fill your distillation flask at least one-third but no more than onehalf full.\ 
...
#set align(center)
== Chapter 2 Production of Spagyric Herbal Extracts
...
Pour the distillate in the receiver into a 2000mL round bottom flask. Distill off all the liquid that will come over at $85degree C$. Place the liquid left in the distillation flask into a mason jar for later use. By this time, our feces should have become a gray ash. Weigh the ash and place it into a mason jar for later use.\

Take the distillate that is in the receiver and distill it five more times using only a water bath. After each distillation take the residue left in the distillation flask and add it to the watery residue from the second distillation. This watery substance is known as phlegm. The distillate is poured back into the distillation flask anew each time (after the removal of the phlegm) and distilled again. When making our last distillation the alcohol should come over at $76degree C$. In this way we are able to get an almost pure ethyl alcohol. Be sure to record the final volumes of your phlegm and alcohol.\ 

Take the second half of your herb and grind it to a fine powder. Put it into the 5000mL round-bottom flask, then pour the entire amount of the alcohol distillate over the herb. Add enough distilled water to the flask so the amount of alcohol in the mixture equals 10% to 20% by volume. Seal the jar adapter and allow its contents to digest in the incubator for fourteen to twentyone days at a temperature of $35degree C$ to $37degree C$; in this way an extract of the plant is made. The presence of the purified alcohol keeps the new plant material from undergoing fermentation. Decant the darkly colored extract from the herb body and store it in another mason jar. Place the mason jar holding the extract back into the incubator to further amalgamate its separate principles. The herb body is taken outside, placed into a large pot and turned to ash. The ash of the maceration and ash of the fermentation are ground and mixed well. Place the combined ash into the thimble of the soxhlet extractor. The phlegm obtained from the purification of the alcohol is used to extract the alkaline water-soluble salts from the ash. Pour the phlegm containing the water-soluble salts into a crucible or pyrex dish and evaporate the water off overnight. The next morning scrape the salts out, grind, and weigh them. The salts are then placed back into the crucible or pyrex dish and put into the kiln and calcined to whiteness. The temperature of the kiln should not be over $600degree C$. This process of extraction, evaporation, grinding, weighing, calcining, and weighing is done up to two more times. In the end, our salts are a pure white (sometimes a bluish tint can be seen). These salts are very alkaline as well as hygroscopic. This latter fact makes them very useful as a vehicle for cosmic forces. Finally grind the salts in a warm mortar and add them to the extract. Let them digest for a week or so with your extract, shaking the jar at least five times a day. Decant the extract off of any sediment that may have settled on the bottom of the mason jar. In this way, we now have a spagyric extract.\ 

#set align(center)
== Chapter 3\ Production of Spagyric Herbal Tinctures

Many people feel that an herbal extract as described in the last chapter can be made healthier and stronger by concentrating it. While the final concentration of the extract can be brought to a 1:1 ratio, the road to this concentration is very detrimental to the cosmic energy that was harvested with the plant at its time of extraction from the ground.\
#set align(left)
...
Press the liquid out of enough grapes to make a half gallon of juice. Pour the juice into the 5000mL round-bottom flask, then add the skins. To determine the alcohol we are making to a specific herb add 1 or 2 ounces of dried herb (It is really best to use an herb picked by your own hand; in this way, you know what formative forces are locked up in the herb.) The entire volume of the contents should not exceed two-thirds of the flask's capacity. Our aim is now to cause a fermentation of the mixture. Add a little brewer's yeast and sugar and use a fermentation lock to close the flask. Put the flask into an incubator at $27degree C$. In two to four days the formation of gas bubbles will announce the start of fermentation. In time the bubbles will stop and the matter will fall to the bottom of the container. This is a sign the fermentation has stopped. In all, it will take about two weeks for the entire process to be completed. Hook up the distillation train to the flask using a 2000mL round bottom flask as the receiver. A water bath will be the best method for this distillation. Hook up the water supply to the condenser and then turn on the heating element. The impure alcohol will distill over at $80degree C$ to $90degree C$ (you can add a few handfulls of sea salt and sandinto the water bath to encrease it's temperature). Distill the soup until no more will rise. Turn the heat off and let it cool. Put a cork into the flask and store it in a cool place until needed later.\

Pour the distillate in the receiver into another 2000mL round bottom flask. Distill off all liquid that will come over at $85degree C$. Place the liquid left in the distillation flask into a mason jar and save it for later use.\ 

Take the distillate that is in the receiver and distill it five more times using only a water bath. After each distillation take the residue left in the distillation flask and add it to the watery substance in the mason jar known as phlegm. The distillate is poured back into the distillation flask a-new each time (after removal of the phlegm) and distilled again. When making our last distillation the alcohol should come over at $76degree C$. In this way we can get an almost pure ethyl alcohol. Be sure to record the final volumes of your phlegm and alcohol.\ 
...
Note well: The sediment of clarifications should all be mixed and thoroughly dried. This should then be calcined to a pure whiteness at $600degree C$. Store these salts in a tightly sealed container. They can be redetermined at a later date and used in another tincture.\ 

#set align(center)
== Chapter 4\ Production of Spagyric Herbal Essences
#set align(left)
...
We will need to put our herb through a steam distillation first so we can obtain its volatile oils. Place a 5000mL round-bottom flask into a sand bath. Pour 3000mL of distilled water into the flask. Take a widemouthed double-jointed flask and place a small piece of filter paper inside the flask over the bottom joint. Add enough ground herb to the flask so it is half full. Next hook up the reduction head and the distillation adapter. Finally, use a 2000mL flask as a receiver at the end of the apparatus.\ 

Turn the heat on low. After some time you will see the steam clouding up the doublejointed flask as it passes through it. Our distillation adapter also will become fogged. At the end of the drip tip you will see water droplets forming. The drops will fall into the receiver. After a few milliliters have collected in the receiver you will notice that a colored oil is collecting on top of the water. When approximately 1500mL of the water has been distilled over, turn off the heat. Let the apparatus cool and transfer the water and oil in the receiver into the oil separator.\ 

Take the double jointed flask off the distillation flask. Pour 1000mL of fresh distilled water into the distillation flask and hook back up the entire apparatus. This entire process should be done at least three times to insure that the majority of the volatile oils come out of the plant body. While our second separation of the volatile oils is under way we will gather the oils obtained from the first. To do this, simply open the stopcock at the end of the drain tube. Slowly drain off the water. When only a little water is left in the separator close the stopcock. After each subsequent extraction of the volatile oils from the plant body, take what is in the receiver and place it in the oil separator. Drain the water out of the separator leaving the oil behind. Reuse this water for all of your subsequent separations of oil from the body. By the time youe have extracted oil from 5 pounds of plant material you will have a few mililiters of pure volatile oil.\ 

Take the essence-depleted bodyof the herb and place it into the widemouthed 5000mL round-bottom flask. The water that was left from the separations of the volatile oils is now poured over the herb. Seal up the round-bottom flask with a fermentation lock and place it into an incubator at $27degree C$. In about two weeks our plant body will have fermented and yielded up its spirit. Distill off the spirit as you have done before and rectify it seven times. Save the phlegm from the spirit for later use.\ 

Empty the remaining liquid and plant body left in the 5000mL flask into a large glass pot. Take the pot outdoors and boil off all the moisture. When the moisture is gone the herb body will begin to roast and then incinerate. When the body has obtained an ash gray color turn off the heat and let the pot cool. Grind and weigh the ash. Set up the soxhlet extraction apparatus and extract the water soluble salts from the ash. Evaporate the water off the salts in the oven overnight. Grind and weigh the salts then place them into the kiln to calcine at $600degree C$ for one week. At the end of the week turn the kiln off and let it cool. Grind and weigh the salts. Repeat the extraction, drying, grinding, weighing, calcining, grinding, and weighing two more times.\ 

Once you have gotten your pure hygroscopic salt, pour your rectified spirit over the salts, then add your volatile oil. Allow the mixture to digest in an incubator at $30degree C$ for a week. Be sure to slightly shake the container three to five times a day. Decant the essence off the undissolved salts. It will be seen that the essence is now colored yellow and smells strongly of the herb you used. One drop in wine or distilled water will yield the full effects of the plant's medicinal nature. Save the remaining salts as you did with those left over from the manufacture of the tincture.\ 
...
Disassemble the distillation train. Add enough rectified spirits of wine to the receiver so its volume equals 7% to 12% of the total volume of liquid in the flask. Place a condenser onto the flask, cork the condenser and hook up the water supply. Using a sand bath and gentle heat ($30degree C$ - $37degree C$) begin a rhythmic circulation of the matter. Heat the matter from 6 am in the morning until 6 pm in the evening. Then allow it to cool overnight and in the next morning begin the circulation again. This circulation should be done for fourteen days.\ 

Take the plant residue left in the distillation flask and transfer it to a large glass pot. Incinerate the contents in the pot. Take the ash out of the pot and extract the water soluble salts from it. Evaporate the water from the salts overnight in the drying oven. Place the dried salts in the kiln and calcine for two weeks at $600degree C$. At the end of two weeks turn the kiln off and let it cool. Take the salts out of the kiln and weigh them then grind the salts fine and place them into a glass petri dish (you can add a few grams of salt saved from the production of another tincture or essence). Take the dish outside at night, and leave it out all night. Be sure to elevate the petri dish at least six inches above ground on a piece of wood. At dawn take the petri dish inside.\ 
...
#set align(center)
== Chapter 5\ Alkahest of the Vegetable Kingdom.
...
Grind both gums to a powder. Place them spoonful by spoonful into a crucible and calcine them to whiteness. In the beginning you will see the impurities burn away from their bodies and rise as a smoke (use a hood or do it outside). When they have become purified to a snowy whiteness they are ready. Use the clear phlegm saved from the rectification of the alcohol to extract the true body of our spirits from the calcined matter.\ 

The body of the spirits is the base of our operation. They must be exceedingly pure. To test their spirituality take them outside on a clear spring day. If truly pure they will turn to liquid and leave no trace of solid behind. When gently heated to remove the moisture of the atmosphere they will turn solid again.\ 
...
#set align(center)
== Chapter 6\ Oil of Rose Quartz extracted via the Alkahest of the Vegetable Kingdom

A word about the use of crystals. People have used crystals and gems for centuries as a means to improve their health and promote the development of psychic powers. Many people even go as far as to place crystals into distilled or spring water with the hopes of promoting a transference of the crystals energy into the water. It is then believed that by drinking the water the individual will ingest the energy of the crystal. I suppose the above method does posses a somewhat limited benefit to the user. But it will be seen from the upcoming formula how far superior the spagyric method is.
#set align(left)
...
In order to perform an extraction of the soul on rose quartz, proceed as follows. Take one pound of rose quartz and break it up into pieces the size of quarters. Place the pieces in a crucible and heat them at $600degree$ to $800degree C$ for one hour. Using a pair of tongs take the crucible out while still red hot. Dump the contents of the crucible into a steel pitcher containing distilled water. After twenty minutes drain the water and put the pieces into a warm crucible. Place the crucible back into the kiln. Heat the quartz pieces as you did before and then dump them into water. After numerous times you will see that the quartz has begun to turn white. When it is completely white you will be able to actually break the quartz apart easily with you bare hands. Be careful of the sharp slivers of quartz because they can cut your hand badly. Grind this quartz to a fine white sand. Place the ground quartz into an Erlenmeyer flask and pour over it your alkahest. Place a cork in the flask and seal it with wax. Digest the flask in a $40degree C$ incubator for four to six weeks. At the end of this time your menstruum will be a light yellow to dark orange in color. Allow the flask to cool but keep it sealed. Set the flask in a cool dark place for two weeks. Break the seal and decant the liquid off of the crystals. Filter the resultant liquid twice and then pour it into a distillation flask. Place the flask into a water bath and gently distill off your menstruum. Please note that you schould have the receiver in an ice bath to insure that you lose none of your spirit. The thick oil left in the distillation flask is the concentrated oil or soul of rose quartz. Place it into an amber-colored glass and stopper it well. Use one to two drops in a glass of wine to receive the full effects of the crystal's power.\ 
...
#set align(center)
== Chapter 7\ Production of a Spagyric Plant Stone
...
#set align(center)
== Chapter 9\ The Minor Opus in Words and Pictures
...
Anyone who has taken the time to work through the experiments of this book will realize at once that the description given in the quote above exactly mimics the steam extraction of the volatile essential oils from a plant. Therefore, set up the oil extraction apparatus you used in the previous experiments and extract the oils from two pounds of plant material. Throughout all of this work of the steam distillation it is very important that you use only the original 2000mL of water you started with. The high heat used to make the steam causes a breakdown of the alchemical qualities of the water. When you have finished your extractions place all of your collected oils into an amber-colored vial and store it for latter use. This oil represents the volatile fraction of our Air element.\ 

Take the two pounds of oil-depleted herb and place them into two separate containers. Pour into each container half of the water used for the extraction of the volatile essential oils. Add enough of the universal Mercury to each container so that the water's volume exceeds four times the volume of the plant material. A large plastic five-gallon winemaking cask will serve nicely. Place a fermentation lock into the cask and leave the cask in a $27degree C$ incubator until fermentation is complete. Take the fermentation locks off of both casks but decant and filter the liquid from only one of them. Place cheesecloth loosely over the second cask and place it in a cool room with good air circulation.
...
Having done this we must use the Fire element to extract the fixed Air from approximately two ounces of unused herb. This fixed tincture is nothing more than the second fraction of our Air element. The first, of course, were the volatile oils extracted from the plant. The second is its tincture, which also contains the smells, color, and medicinal qualities of the herb. This extraction should be done by a very gentle digestion; that is if one is planing on using the alchemical elixir of the first degree. If you do not plan on using this intermediary medicine then you can use a soxhlet extractor to obtain the fixed Air. In the latter case, we are not concerned with damage done to heatsensitive alkaloids because all of the combined substances will go into the kiln for purification. In any event once, you have the fixed Air element, you must separate its volatile portion from the fixed part. During the digestion the Fire element also extracted some of the volatile Air. The separation of the volatile from the fixed may be done either by exhalation of the vapors (sweating) which allows the Fire and volatile Air element to come over together, or we can use a standard distillation setup. In this way though we are destroying a large part of the seminal virtues of our plant before they are amalgamated to its Earth element. In either method, place the clear liquid that you have collected in a tightly sealed mason jar and label it as the Fire and volatile Air element combined. Take the dark fixed Air left in the distillation flask and label it fixed Air of the herb in question.\ 
...
Once the extraction is complete pour the saline solution into a Pyrex dish and place it into an oven overnight at $100degree F$ so the water will evaporate off. When dried, scrape these salts out of the dish and weigh them.\ 
...
The darkness in the center of the matter seems to have compressed itself into bands. The top of the matter has a slimy, festering look about it.\ 
...
I would like to make a comment here about the next three pictures. The stones shown on this plate are not the same as the one shown in the putrefaction series. The stone forming in the putrefaction series was my sixth and last attempt at this process. I had then finally figured out how to use the sealed vase of Hermes. Unfortunately, the last half of the photos showing the color changes of the stone was lost by the photography developing lab. I was unable to redo the experiment because the space that I had been using for a laboratory was no longer available to me. To make matters worse, during an experiment with my last stone the crucible holding it broke and it flowed all over the floor of the kiln. Be that as it may, these next three photos, though crude, do show the color changes one can expect to see.\ 
...
== Suggested Readings
Albertus, Frater\ 
Alchemical Laboratory Bulletins 1960 - 1972\ 
Salt lake City, Utah: Paracelsus Research Society.\ 

Albertus, Frater\ 
Essentia Magazine Winter 1980 - Fall 1983\ 
Salt lake City, Utah: Paracelsus College\ 
...
Albertus, Frater\ 
Parachemy Magazine 1973 - 1979\ 
Salt lake City, Utah: Paracelsus Research Society.\ 

Albertus, Frater\ 
The Alchemist Handbook\ 
Salt lake City, Utah: Paracelsus Research Society, 1974\ 

Albertus, Frater\ 
The Alchemist of the Rocky Mountains\ 
Salt lake City, Utah: Paracelsus research Society 1976.\ 
...
Albertus, Frater\ 
From "One to Ten"\ 
Salt lake City, Utah: Paracelsus Research Society 1966\ 
...
Barbault, Armand\ 
Gold of A Thousand Mornings. Robin Campbell. London:\ 
Neville Spearman, 1975.\ 

Bardon, Franz\ 
Initiation into Hermetics\ 
Dieter Ruggeberg 1981.\ 

Bardon, Franz\ 
The Key to the True Quabbalah\ 
Published by Dieter Ruggeberg 1986\ 

Bardon, Franz\ 
The Practice of Magical Evocation\ 
Dieter Ruggeberg 1984.\ 

Bardon, Franz\ 
Frabato the Magician\ 
Dieter Ruggeberg 1982.\ 

Baron, Urbigerus\ 
The Golden Manuscripts "Circulatum Urbigerus"\ 
Para Publishing Inc. 1973.\ 

Cockren, A.\ 
Alchemy Rediscoverd and Restored\ 
Mokelumme Hill, CA.: Health Research 1963.\ 
...
Para Publishing 1978.\ 

Fulcanelli Master Alchemist Le Mystere des Cathedrales\ 
Mary Swoder\ 
Brotherhood of Life 1984.\ 

Fyfe, Agnes\ 
Moon and Plant Capillary Dynamic Studies\ 
Society for Cancer Research 1975.\ 

George, Llewellyn\ 
The All New A to Z Horoscope Maker and Delineator\ 
Llewellyn Publications\ 

Gerber, Richard\ 
Vibrational Medicine\ 
Sante Fe, N.N.: Bear and Company 1988.\ 

Gluber, Valentine and others\ 
A Compendium of Alchemical Processes\ 
York Beach, Main: Samuel Weiser, Inc. 1981.\ 

Grieve Mrs. M\ 
A Modern Herbal in Two Volumes\ 
Neew York: Dover Publications, Inc. 1971.\ 
...
Hartman, Franz\ 
The Secret Symbols of the Rosicrucians of the 16th & 17th Centuries\ 
Occult Publishing Company 1969.\ 

Ingalese, Richard\ 
The Golden Manuscripts "They Made the Philosophers Stone"\ 
Para Publishing Co, Inc. 1973.\ 

Junius, Manfred M.\ 
Practical Handbook of Plant Alchemy\ 
Inner Traditions International Ltd. 1985.\ 

Kaplan, Aryeh\ 
Sefer Yetzirah The book of Creation\ 
York Beach, Main: Samuel Weiser, Inc. 1990\ 

Kolisko, L.\ 
Gold and the Sun. The Total Eclipse of the Sun 20 May 1947\ 
The Anthroposophic Press 1947.\ 

Kolisko, L.\ 
The Moon and the Growth of Plants\ 
Anthroposophical Agricultural Foundation 1936.\ 

Lacinius Janus\ 
The New Pearl of Great Price\ 
London England: Vincent Stuart LTD. 1963.\ 
...
Anthroposophic Press 1975.\ 

Philalethis, Eirenaeus and others\ 
Collectanea Chemica\ 
London England: Vincent Stuart LTD. 1963.\ 

Rulandus, Martinus\ 
A Lexicon of Alchemy\ 
York Beach, Main: Samuel Weiser, Inc. 1984.\ 

Synesius\ 
The Golden Manuscripts The True Book of the Learned Synesius\ 
Para Publishing Co, Inc. 1973.\ 

Valentinus, Basilus\ 
The Triumphal Chariot of Antimony\ 
With a commentary by Theodore Kerckringius\ 
London England: Vincent Stuart LTD. 1962.\ 

Volpierre\ 
The Golden Manuscripts The Hermetic Art\ 
Para Publishing Co, Inc. 1974.\ 

Waite, Arthur Edward\ 
The Hermetic and Alchemical Writings of Paracelsus in Two Volumes\ 
