...
#inner-work[
  *Mapping the Boundary*
  ...
  Contemplate the boundary between the kingdoms as an inner experience. What in
  you feels "vegetable" (green, seasonal, growing)? What feels "mineral"
  (crystallised, slow, enduring)?

  Record your reflections. This awareness will be crucial as you prepare for
  Year Two's focus on the bridge between kingdoms.
]
