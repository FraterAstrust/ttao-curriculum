...
A plant that resembles a part of the human body is understood to govern it. This is the external expression of an internal spiritual link.

The *Chain of Correspondences* extends from the heavens down to the physical body: a single planetary force governs a specific metal, a specific day of the week, a specific plant, and a specific organ or system in the practitioner. To understand the plant in your flask is to understand the planetary force in your own body.
...
#inner-work[
  *Tarot Keywords: The Major Arcana*
  ...
  Work through the 22 Major Arcana with Paul Foster Case's *The Tarot*. For each card, identify the common theme or archetypal force it represents.

  Assign a single *keyword* of your own choosing for each card — one that captures its essential nature for you personally. These keywords will form your personal Tarot vocabulary and will evolve as your understanding of the Great Work deepens.
]
