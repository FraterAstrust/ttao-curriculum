...
#hm-note[
  This is the *Headmaster's Master Guide* for Year One. It contains full doctrinal rationale, comparative source notes, alternate pathways, pedagogical commentary, and intervention thresholds. Students receive only the simplified monthly syllabus extracted from this document.
  
  *Do not issue this file to students.*
]
...
+ *Triple separation demonstrated* — the student can describe and evidence the separation of Mercury (essence / spirit of wine extraction), Sulphur (aromatic fraction), and Salt (calcined ash) from the same plant material.
+ *Cohobation completed at least once* — the calcined salt has been moistened with the liquid essence and digested under gentle warmth until the liquid clears.
+ *Diagnostic test passed* — the preparation, when gently warmed, exhibits the characteristic flow described in the tradition: soft and plastic, not brittle and dry. A dry, inert salt indicates the natural moisture was destroyed in calcination (vitrification) or overheating.

Acceptable evidence: photographs of each stage with dates; weight records before and after calcination; written description of the cohobation sequence; the headmaster's or guide's direct observation via video session.
...
*suggested rhythm*, not a deadline. Some students will move through the conceptual months (M01–M02) quickly and slow at the first operative month (M03). Others will find the inner work far harder than the laboratory. Neither pattern is wrong.

The only non-negotiable sequencing rule: *the meditation practice must be genuinely established before the student advances to the Desoille descent work in Month 6.*
The descent work builds on the capacity for sustained, directed inner attention that only consistent daily sitting develops. A student who arrives at M06 without an established practice will not be harmed by the descent exercises, but they will get far less from them — and may produce an agitated rather than illuminating inner encounter. Hold them at M01–M02 until the practice is real.

=== On the Oath

The Declaration of Intent written in Week 1 is a live document, not a formality.

Return to it at the Quarter IV gathering. A student who has quietly abandoned its spirit — who has begun to think of alchemy as a personal advancement project — will often reveal this without knowing it in the Q4 sharing. Address it gently but directly.

=== On the Inner / Outer Split

The most common Year One failure mode is treating the laboratory and the inner work as separate tracks — doing one seriously and the other perfunctorily. The curriculum's parallel threading is deliberate. When a student's laboratory work stalls, examine the inner work journal: the two consistently mirror each other. A student whose calcination is vitrifying often describes, in the same period, an inability to sit still in meditation or a restless quality in their nature vigils. Point this out. It is not mysticism — it is pattern recognition.
...
_The first quarter establishes the three foundations upon which everything else rests: the philosophical reorientation that is the Hermetic Paradigm; the threefold model of Mercury, Sulphur, and Salt as an operative framework rather than an abstraction; and the physical reality of the laboratory — the first herb, the first fire, the first waiting._
...
They will not yet have produced anything. The maceration is still in progress. The salt has not yet been made. This is correct. Quarter One is not about results — it is about establishing the conditions in which results become possible.

#doctrine[
  _"The theory is dry without the praxis. Doing the laboratory work will thoroughly ingrain the theory and make it LIVE within and without you."_
...
_The second quarter carries the Melissa preparation through its first major operation: calcination. The student separates the three principles by burning, and faces for the first time the inner Nigredo — the encounter with shadow material that accompanies any genuine alchemical fire._
...
#doctrine[
  _"There are many things tucked away deep in our unconscious that we prefer to forget, and it takes energy to keep them hidden — energy that is better used elsewhere."_
...
_The third quarter turns to the subtler instruments: the vigil, the Tarot as alchemical mirror, the Qabalah as a living map, and distillation — the operation that lifts the volatile from the fixed. Externally, the student produces the Melissa hydrosol and possibly a separated oil fraction. Internally, the Dawn is beginning._
...
_The fourth quarter brings the separated principles back together. Cohobation reunites what distillation and calcination separated — purified by the passage through fire and water. The Plant Stone, if it forms, is the culminating operative achievement of Year One. Whether or not the Stone has fully formed, the student advances to Year Two with a clear understanding of everything the first year required._
