...
The laboratory is the alchemist's outer sanctuary. It need not be elaborate — a corner in a basement or attic, a source of gentle heat, cold water for condensing, and a few glass flasks. As Frater Albertus notes, just as an artist needs only canvas, paint, and brushes, the alchemist needs only fire, vessel, and matter.

The heat of the laboratory is everything. The ancients distinguished four degrees of fire, each appropriate to different operations:
...
#inner-work[
  *The Inner Flame*
  ...
  This week, add the *Inner Flame* practice to your daily sitting. After the Third Eye Focus and the Threefold Breath, settle into stillness.

  *The Practice:*
  Form in the mind's eye — or simply as a felt sense — the image of a small flame burning quietly in the centre of your body, below the ribs and above the pelvis. This flame does not burn or harm; it is the *Secret Fire* present in all living things.

  As you breathe, notice the flame. When the mind wanders, return to it with simple attention. Let it be the same fire you work with externally in the laboratory.
]
