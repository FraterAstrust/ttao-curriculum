...
#week-title("One", "Lunar Phases: The Tide of the World Spirit")
...
- The Moon as the primary mediator of the World Spirit
- Practical application of lunar phases (Waxing vs. Waning)
- The rhythm of extraction and reduction
...
#inner-work[
  *The Minor Arcana & The Four Elements*
  ...
  - *Cups / Water:* emotion, relationship, psychic sensitivity.
  - *Swords / Air:* intellect, thought, word, conflict.
  - *Pentacles / Earth:* material substance, body, practical labour.
]

=== Source Readings — Week 1

- #src("GCH I", "Part I — Chapter IV: In What Manner the Universal Seed")
- #src("RA", "Chapter Three — Astrology and Alchemy (focus on lunar cycles)")
- #src("QTar", "Section 2.3 — Minor Arcana")
