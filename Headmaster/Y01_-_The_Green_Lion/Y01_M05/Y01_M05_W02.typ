...
#week-title("Two", "Planetary Hours & Days")
...
- The Seven Classical Planets as alchemical forces
- Calculating Planetary Hours from sunrise and sunset
- Selecting auspicious moments for laboratory beginnings
...
- #src("AH", "Chapter V — Herbs and Stars (re-reading)")
- #src("PFC", "Chapter 2 — Occult Meaning of Numbers (4–9)")
- #src("NDT", "Chapter 1 — Numbers 4 through 9")
