...
#week-title("Four", "Practical Timing & Directional Reading")
...
- Gathering herbs at the correct lunar time
- Tracking the maceration alongside the lunar calendar
- Integration of astronomical timing into laboratory notes
...
#inner-work[
  *The First Directional Reading*
  ...
  4. *West (Water/Cups):* Emotional or psychic tone.
...
- #src("PFC", "Chapter 3 — Construction of the Tarot")
- #src("QTar", "Section 2.5 — Four-Directional Layout")
