...
#week-title("Three", "Salt — The Body Principle")
...
- Salt as the body-principle: definitions and distinctions
- The fixed vs. the volatile: Salt as the anchor
- Why alchemical Salt is not common table salt
- The unique character of plant salts
...
- #src("AH", "Chapter II — The Lesser Circulation (section on Salt)")
- #src("RA", "Chapter Two — Theory of Alchemy (focus on the Body principle)")
- #src("GCH I", "Part I — Chapter II: Out of Whom or Out of What Everything Was Born (concluding section)")
- #src("NDT", "Chapter 1 — Esoteric Numerology: Number 3")
